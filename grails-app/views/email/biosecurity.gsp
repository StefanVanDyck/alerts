...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f4f4f4;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;border-spacing: 0;border-collapse: collapse;">
    <tr>
        <td align="center" style="padding: 20px;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
            <table border="0" cellpadding="0" cellspacing="0" width="650" style="background-color: #ffffff;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;border-spacing: 0;border-collapse: collapse;">
                ...
                <!-- Header -->
                <tr>
                    <td align="center" bgcolor="#B53929" background="${grailsApplication.config.grails.serverURL}/assets/email/biosecurity-alert-header.png" width="620" height="120" style="color:white;background-color:#B53929;padding: 20px 10px 20px 10px;text-align: center;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;background-image:url(${grailsApplication.config.grails.serverURL}/assets/email/biosecurity-alert-header.png);background-position: top center;background-size: cover;background-repeat: no-repeat">
                        ...
                        <p style="font-size: 16px; color: #fff;">Alerts service for new VBP records listing potential invasive species</p>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="background-color: #E8E8E8;color: #000;padding: 40px 30px 40px 30px;text-align: center;font-family: 'flanders-sans', sans-serif;font-size: 22px;line-height: 1.5;">
                ...
                <tr>
                    <td style="padding: 20px;background-color: white;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;border-spacing: 0;border-collapse: collapse;">
                            <tr>
                                <td width="46%" valign="top" style="font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
                                    <a href="${query.baseUrlForUI}/occurrences/${oc.uuid}" style="color: #C44D34;text-decoration: none;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
                                ...
                                <td width="28%" valign="top" style="font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
                                    <a href="https://www.google.com/maps/place/${oc.latLong}" target="_blank" style="font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
                                ...
                                <td width="26%" valign="top" style="font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
                ...
                <tr>
                    <td style="padding: 35px 70px 35px 70px;background-color: #C44D34;color: #fff;font-family: 'flanders-sans', sans-serif;font-size: 14px;line-height: 1.43;text-align: center;">
                ...
                <tr>
                    <td style="padding: 35px 70px 35px 70px;background-color: #000000;color: #fff;font-family: 'flanders-sans', sans-serif;font-size: 14px;line-height: 1.43;;text-align: center;">
                ...
                <tr>
                    <td style="padding: 35px 70px 35px 70px;background-color: #ffffff;color: #000;font-family: 'flanders-sans', sans-serif;font-size: 14px;line-height: 1.43;text-align: center;">
                        <p>
                        ...
                        <div style="margin-top: 25px;">
                            ...
                            <br/>
                            You are receiving this email because you opted in to VBP alerts.
                            <br/>
