...
<table style="width: 100%; background-color: #f4f4f4;border-spacing: 0;border-collapse: collapse;">
    <tr>
        <td align="center" style="padding: 20px;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
            <table style="width: 650px; background-color: #ffffff; font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;border-spacing: 0;border-collapse: collapse;">
                <!-- Logo -->
                <tr>
                            ...
                            <tr style="vertical-align: top;">
                                <td style="width: 37%">
                                    ...
                                    <p style="padding-left: 15px;">
                                        ...
                                        <g:if test="${oc.taxonRankID > 5000}"></i></g:if>
                                        ${oc.stateProvince}<br/>
                                        <g:message code="alerts.family" args="${[oc.family]}"/><br/>
                                        <g:if test="${oc.dataProviderName}">
                                            <g:message code="alerts.source" args="${[oc.dataProviderName]}"/>
                                        </g:if>
                                    </p>
                                </td>
                                <td class="annotation" nowrap="nowrap" style="width: 30%">
                                    <g:if test="${oc.eventDate}">
                                        <g:message code="alerts.date.created" args="${[new SimpleDateFormat("dd MMM yyyy").format(oc.eventDate)]}"/><br/>
                                    </g:if>
                                </td>
