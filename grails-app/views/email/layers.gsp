          ...
          <td style="background-color: #E8E8E8;color: #000;padding: 40px 30px 40px 30px;text-align: center;font-family: 'flanders-sans', sans-serif;font-size: 22px;line-height: 1.5;">
            <div>
              <g:if test="${totalRecords == 1}">
                <g:message code="spatial.layers.update.title" args="${[totalRecords]}"/>
              </g:if>
              <g:else>
                <g:message code="spatial.layers.updates.title" args="${[totalRecords]}"/>
              </g:else>
            </div>
          </td>
        </tr>
            ...
            <td style="padding: 20px;background-color: white;font-family: 'flanders-sans', sans-serif;font-size: 14px;line-height: 1.5;">
              ...
              <table style="width: 100%">
                <tr style="vertical-align: top;">
                  <td style="width: 70%">
                    <a href="${oclink}" style="color: #C44D34;text-decoration: none;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
