...
<table  cellpadding="0" cellspacing="0" width="100%" style="border:0; background-color: #f4f4f4;border-spacing: 0;border-collapse: collapse; ">
    <tr>
        <td align="center" style="padding: 20px;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
            <table border="0" cellpadding="0" cellspacing="0" width="650" style="border:0; background-color: #ffffff;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;border-spacing: 0;border-collapse: collapse;">
                <!-- Logo -->
                <tr>
                ...
                <tr>
                    <td style="background-color: #E8E8E8;color: #000;padding: 40px 30px 40px 30px;text-align: center;font-family: 'flanders-sans', sans-serif;font-size: 22px;line-height: 1.5;">
                        <div> <g:if test="${totalRecords == 1}">
    <g:message code="biocache.occurrences.record.update.title" args="${[totalRecords]}"/>
</g:if>
<g:else>
    <g:message code="biocache.occurrences.records.update.title" args="${[totalRecords]}"/>
</g:else>
                        </div>
                    </td>
                </tr>
                        ...
                        <table style="width: 100%">
                            <tr style="vertical-align: top;">
                                <td style="width: 33%">
                                    ...
                                    <a href="${occurrencelink}" style="color: #C44D34;text-decoration: none;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;">
                                ...
                                <td class="annotation" nowrap="nowrap" style="width: 34%;word-wrap: break-word; white-space: normal;font-family: 'flanders-sans', sans-serif;font-size: 12px;line-height: 1.5;">
