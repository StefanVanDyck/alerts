                    ...
                    <td style="background-color: #E8E8E8;color: #000;padding: 40px 30px 40px 30px;text-align: center;font-family: 'flanders-sans', sans-serif;font-size: 22px;line-height: 1.5;">
                        <div>
                            <g:if test="${totalRecords == 1}">
                                <g:message code="specieslists.update.title" args="${[totalRecords]}"/>
                            </g:if>
                            <g:else>
                                <g:message code="specieslists.updates.title" args="${[totalRecords]}"/>
                            </g:else>
                        </div>
                    </td>
                </tr>
                        ...
                        <td style="padding: 20px;background-color: white;font-family: 'flanders-sans', sans-serif;font-size: 14px;line-height: 1.5;">
                            ...
                            <table style="width: 100%">
                                <tr style="vertical-align: top;">
                                    <td style="width: 70%">
                                                <strong>${i+1}.<a href="${oclink}" style="color: #003A70;font-family: 'flanders-sans', sans-serif;font-size: 16px;line-height: 1.5;"> <em>${oc.listName}</em> </a></strong>
